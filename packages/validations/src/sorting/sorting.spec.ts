...
import { SortingQueryStringSchema } from './sorting'
import { SortingParams } from './sorting.decorator'

// Create schemas for testing
const defaultSchema = SortingQueryStringSchema(['email', 'computedField'])
...
describe('sorting', () => {
  ...
  describe('createSortQuerySchema function', () => {
    it('should create schema with custom values', () => {
      const schema = SortingQueryStringSchema(['name', 'age'])

...
import { FilterQueryStringSchema, FilterRule } from './filtering'
import { FilteringParams } from './filtering.decorator'

// Create schemas for testing
const defaultSchema = FilterQueryStringSchema(['email', 'age', 'active'])
...
describe('filtering', () => {
  ...
  describe('createFilterQuerySchema function', () => {
    it('should create schema with custom properties', () => {
      const schema = FilterQueryStringSchema(['name', 'status'])
    ...
    it('should reject filters with invalid properties', () => {
      const schema = FilterQueryStringSchema(['name'])

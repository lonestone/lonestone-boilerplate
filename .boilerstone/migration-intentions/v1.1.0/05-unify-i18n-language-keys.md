...
- React Router 8 `loaderData` — `v1.1.0/migrate-react-router-8`.
...
Run `pnpm boilerplate upgrade record --id v1.1.0/unify-i18n-language-keys --applied` after validation passes, or record it as skipped with a reason.

...
3. ### Update the database
   ...
   For detailed instructions on database migrations and schema updates, check out the [Migrations explanation](/lonestone-boilerplate/explanations/3_database_migrations).
   :::

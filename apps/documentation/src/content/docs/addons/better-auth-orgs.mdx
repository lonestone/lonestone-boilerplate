...
However, you may need to implement custom business logic specific to your application. In this case, create your own Nest providers/services (or call `AuthService` from `@thallesp/nestjs-better-auth`) to handle organization-related operations that go beyond what Better Auth provides out of the box.

...
See the [Database Migrations](/explanations/3_database_migrations) page for more details.
:::
...
Remember to respect the production safety rules described in the [Database Migrations](/explanations/3_database_migrations) page.
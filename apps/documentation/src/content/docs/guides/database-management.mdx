...
See the [Database Migrations](/lonestone-boilerplate/explanations/3_database_migrations) page for more details.
:::
...
Remember to respect the production safety rules described in the [Database Migrations](/lonestone-boilerplate/explanations/3_database_migrations) page.
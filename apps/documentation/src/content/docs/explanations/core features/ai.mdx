...
Langfuse uses OpenTelemetry to trace the calls to the LLMs (it plays well with Vercel SDK). You can see how OPT is setup in the [AI service file](https://github.com/lonestone/lonestone-boilerplate/blob/main/apps/api/src/modules/ai/ai.service.ts).

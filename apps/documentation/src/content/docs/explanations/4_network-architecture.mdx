...
- **Technology-agnostic**: REST does not lock us—or our clients—into a specific stack. Since we do not always build the frontend, this ensures our API remains accessible to any technology choice. This is also helpful when building tools (e.g. MCP).

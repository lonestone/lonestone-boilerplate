...
- Use components from @pitchkit/ui in ./packages/ui.
- Check types, schemas and sdk from @pitchkit/openapi-generator in ./packages/openapi-generator.
...
- Use @pitchkit/i18n for internationalization, no hardcoded strings.
